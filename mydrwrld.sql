...
CREATE TABLE public.doctors (
    ...
    qualification_id integer DEFAULT 0,
    year_of_experiance character varying(255),
    licence_no character varying(255),
    licenece_type_id integer DEFAULT 0,
...
COPY public.areas (id, name_en, name_ar, active, deleted_at, created_at, updated_at) FROM stdin;
\.
...
COPY public.doctors (id, user_id, hospital_id, qualification_id, year_of_experiance, licence_no, licenece_type_id, country_of_orgin, gender, insurence_id, sub_insurence_id, profile_desciription, created_at, updated_at, deleted_at) FROM stdin;
\.
...
COPY public.emirates (id, name_en, name_ar, active, deleted_at, created_at, updated_at) FROM stdin;
\.
...
COPY public.hospitals (id, user_id, country_id, emirate_id, area_id, address, website, profile_description, trade_licenece, created_at, updated_at, deleted_at) FROM stdin;
\.
...
1	IMA Registrations	Ima reg	1	1	1	2024-04-11 04:46:10	2024-04-12 03:32:41	\N
\.
...
46	2024_04_12_102945_create_doctors_table	17
...
3	Pediatrics	Pediatrics	1	1	1	2024-04-11 06:30:15	2024-04-11 10:37:49	\N
4	PHd	Phd	1	1	1	2024-04-11 10:37:37	2024-04-12 13:06:27	\N
\.
...
COPY public.users (id, name, email, dial_code, phone, phone_verified, password, email_verified_at, role, verified, user_type_id, first_name, last_name, user_image, user_phone_otp, remember_token, created_at, updated_at, deleted, role_id, active, user_code, created_by, last_updated_by) FROM stdin;
3	developer	developer@a2.com	\N	\N	0	$2y$12$.rs4b5JhZNF372Xi5OJkDe2VgmGjh2lwaOzHxQIg0KS2tmiS/fqce	\N	\N	0	\N	\N	\N	\N	\N	\N	2024-03-25 05:37:18	2024-03-25 05:37:18	0	0	1	\N	0	0
4	subadmin	subadmin@gmail.com	\N	123455	0	$2y$12$5QhURKYgL9vqsNaSe4hRqOcdduFQ.95WqmjN/Y8b7HS75XSlWq53W	\N	1	1	\N	add	asda	\N	\N	\N	2024-03-25 05:45:09	2024-03-25 05:49:16	1	1	0	\N	0	0
8	Sooraj Sabu	sooraj.a2solution@gmail.com	93	9847823799	0	$2y$12$w//jrBIM8SAliILyGTylgOAdIzL5h6GBnbAiamBIopgEkwfYDKvpa	\N	3	0	\N	Sooraj	Sabu	\N	\N	\N	2024-03-26 05:37:41	2024-03-26 05:37:41	0	0	1	BLC-66025f253f697	0	0
12	Sooraj Sabu	sooraj.a2solutions@gmail.com	358	9847823799	0	$2y$12$rHuzbjvzLMfN4p1KNUD83..sD23kBtIm3aeUq4FXwigu3tGKegBNu	\N	3	0	\N	Sooraj	Sabu	\N	\N	\N	2024-03-26 05:46:03	2024-03-26 05:46:03	0	0	1	BLC-6602611b19026	0	0
6	dev dev	developer@gmail.com	\N	\N	0	$2y$12$UR5BkkQQrGtgykjXde3bVe.3YZaMVR7UYwZFo2uvwyj.NQCPS4Rh6	\N	1	1	\N	dev	dev	\N	\N	\N	2024-03-25 05:53:05	2024-04-09 07:04:17	1	2	0	\N	0	0
1	Admin	admin@admin.com	971	112233445566778899	0	$2y$12$nplGVHg7DQPp9uHBc3Rb7OT2Lh09Z.ORy4NihaFbir1fq/dRR2/Oi	\N	1	1	1	\N	\N	\N	\N	\N	\N	2024-03-22 12:32:29	0	1	1	\N	0	0
7	admin sub	adminsub@gmail.com	\N	\N	0	$2y$12$d3fiOttEff7UgNMU0Z9cFOsb7sFTBLRDzJBfdX2DRsAWXCdzjNNUu	\N	1	1	\N	admin	sub	\N	\N	\N	2024-04-11 06:41:52	2024-04-11 10:32:03	0	2	1	\N	0	0
\.
...
SELECT pg_catalog.setval('public.doctor_intrests_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.emirates_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.hospital_images_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.qualifications_id_seq', 4, true);
