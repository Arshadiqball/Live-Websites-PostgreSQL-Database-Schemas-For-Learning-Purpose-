...
CREATE TABLE public.app_banners (
    ...
    banner_image_ar character varying(600)
);
...
--
-- Name: contact_us_data; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.contact_us_data (
    id bigint NOT NULL,
    ...
    facebook_link character varying(255) DEFAULT '#'::character varying,
    twitter_link character varying(255) DEFAULT '#'::character varying,
    instagram_link character varying(255) DEFAULT '#'::character varying,
    pinterest_link character varying(255) DEFAULT '#'::character varying,
    linkedin_link character varying(255) DEFAULT '#'::character varying,
    created_at timestamp(0) without time zone,
    updated_at timestamp(0) without time zone,
    map_url character varying(1000) DEFAULT '#'::character varying
);


ALTER TABLE public.contact_us_data OWNER TO postgres;

--
-- Name: contact_us_data_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.contact_us_data_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.contact_us_data_id_seq OWNER TO postgres;

--
-- Name: contact_us_data_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.contact_us_data_id_seq OWNED BY public.contact_us_data.id;
...
--
-- Name: coupon_image; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.coupon_image (
    id bigint NOT NULL,
    coupon_id integer DEFAULT 0 NOT NULL,
    coupon_banner character varying(600),
    created_at timestamp(0) without time zone,
    updated_at timestamp(0) without time zone
);


ALTER TABLE public.coupon_image OWNER TO postgres;

--
-- Name: coupon_image_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.coupon_image_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.coupon_image_id_seq OWNER TO postgres;

--
-- Name: coupon_image_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.coupon_image_id_seq OWNED BY public.coupon_image.id;


--
-- Name: coupon_order; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.coupon_order (
    id bigint NOT NULL,
    ...
    earned double precision DEFAULT '0'::double precision NOT NULL,
    status integer DEFAULT 1 NOT NULL
);


ALTER TABLE public.coupon_order OWNER TO postgres;

--
-- Name: coupon_order_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.coupon_order_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.coupon_order_id_seq OWNER TO postgres;

--
-- Name: coupon_order_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.coupon_order_id_seq OWNED BY public.coupon_order.id;
...
CREATE TABLE public.hide_stories (
    id bigint NOT NULL,
    user_id bigint NOT NULL,
    hidden_user_id bigint NOT NULL,
    created_at timestamp(0) without time zone,
    updated_at timestamp(0) without time zone
);
...
CREATE TABLE public.home_banners (
    ...
    button_address character varying(255),
...
ALTER TABLE public.home_banners_id_seq OWNER TO postgres;
...
--
-- Name: home_page_about_data; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.home_page_about_data (
    id bigint NOT NULL,
    image character varying(255) NOT NULL,
    title character varying(255) NOT NULL,
    subtitle character varying(255),
    button_text character varying(255),
    button_href character varying(255) DEFAULT '#'::character varying,
    created_at timestamp(0) without time zone,
    updated_at timestamp(0) without time zone,
    video_link character varying(255) DEFAULT '#'::character varying
);


ALTER TABLE public.home_page_about_data OWNER TO postgres;

--
-- Name: home_page_about_data_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.home_page_about_data_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.home_page_about_data_id_seq OWNER TO postgres;

--
-- Name: home_page_about_data_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.home_page_about_data_id_seq OWNED BY public.home_page_about_data.id;
...
--
-- Name: operating_hours_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.operating_hours_id_seq OWNER TO postgres;

--
-- Name: operating_hours_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
CREATE TABLE public.order_products (
    ...
    product_attribute_id bigint DEFAULT '0'::bigint NOT NULL,
...
--
-- Name: our_customers; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.our_customers (
    id bigint NOT NULL,
    name character varying(255) NOT NULL,
    image character varying(255) NOT NULL,
    created_at timestamp(0) without time zone,
...
ALTER TABLE public.our_customers OWNER TO postgres;

--
-- Name: our_customers_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.our_customers_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.our_customers_id_seq OWNER TO postgres;

--
-- Name: our_customers_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.our_customers_id_seq OWNED BY public.our_customers.id;
...
CREATE TABLE public.privacy_policies (
    ...
    parah_1 character varying(1000) NOT NULL,
    parah_2 character varying(1000),
    created_at timestamp(0) without time zone,
    updated_at timestamp(0) without time zone
);
...
--
-- Name: service_obtains; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.service_obtains (
    id bigint NOT NULL,
    user_id bigint NOT NULL,
    vendor_id bigint NOT NULL,
    ...
    created_at timestamp(0) without time zone,
    updated_at timestamp(0) without time zone,
    reviews character varying(1000) DEFAULT ''::character varying,
    rating character varying(255) DEFAULT ''::character varying,
    reviewed_at character varying(255) DEFAULT ''::character varying
);


ALTER TABLE public.service_obtains OWNER TO postgres;

--
-- Name: service_obtains_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.service_obtains_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.service_obtains_id_seq OWNER TO postgres;

--
-- Name: service_obtains_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.service_obtains_id_seq OWNED BY public.service_obtains.id;
...
--
-- Name: term_conditions; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.term_conditions (
    id bigint NOT NULL,
    title character varying(255) NOT NULL,
    subtitle text NOT NULL,
    parah_1 character varying(1000) NOT NULL,
...
ALTER TABLE public.term_conditions OWNER TO postgres;

--
-- Name: term_conditions_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.term_conditions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.term_conditions_id_seq OWNER TO postgres;

--
-- Name: term_conditions_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.term_conditions_id_seq OWNED BY public.term_conditions.id;
...
CREATE TABLE public.testimonials (
    ...
    created_at timestamp(0) without time zone,
    updated_at timestamp(0) without time zone,
    rating character varying(255) DEFAULT '5'::character varying
);
...
CREATE TABLE public.users (
    ...
    subscription_services character varying(255),
    subscription_duration character varying(255),
    subscription_id bigint,
    coupon_used character varying(255) DEFAULT '0'::character varying NOT NULL,
    subscription_end_at character varying(255),
...
CREATE TABLE public.vendor_details (
    ...
    created_at timestamp(0) without time zone,
    updated_at timestamp(0) without time zone,
    industry_type bigint DEFAULT '0'::bigint NOT NULL,
    user_id bigint DEFAULT '0'::bigint NOT NULL,
...
--
-- Name: video_downloads; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.video_downloads OWNER TO postgres;

--
-- Name: video_downloads_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.video_downloads_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.video_downloads_id_seq OWNER TO postgres;

--
-- Name: video_downloads_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.video_downloads_id_seq OWNED BY public.video_downloads.id;
...
--
-- Name: video_views_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.video_views_id_seq OWNER TO postgres;

--
-- Name: video_views_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: contact_us_data id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.contact_us_data ALTER COLUMN id SET DEFAULT nextval('public.contact_us_data_id_seq'::regclass);
...
--
-- Name: coupon_image id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.coupon_image ALTER COLUMN id SET DEFAULT nextval('public.coupon_image_id_seq'::regclass);


--
-- Name: coupon_order id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.coupon_order ALTER COLUMN id SET DEFAULT nextval('public.coupon_order_id_seq'::regclass);
...
--
-- Name: home_page_about_data id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.home_page_about_data ALTER COLUMN id SET DEFAULT nextval('public.home_page_about_data_id_seq'::regclass);
...
--
-- Name: our_customers id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.our_customers ALTER COLUMN id SET DEFAULT nextval('public.our_customers_id_seq'::regclass);
...
--
-- Name: service_obtains id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.service_obtains ALTER COLUMN id SET DEFAULT nextval('public.service_obtains_id_seq'::regclass);
...
--
-- Name: term_conditions id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.term_conditions ALTER COLUMN id SET DEFAULT nextval('public.term_conditions_id_seq'::regclass);
...
--
-- Name: video_downloads id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.video_downloads ALTER COLUMN id SET DEFAULT nextval('public.video_downloads_id_seq'::regclass);


--
-- Name: video_views id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
COPY public.app_banners (id, banner_title, banner_image, active, created_by, updated_by, created_at, updated_at, category_id, product_id, type, division_id, outlet_id, banner_image_ar) FROM stdin;
\.
...
1	Al Ain	1	1	3	1	\N	0	2024-05-24 00:52:55	2024-05-24 00:52:55
2	Ajman	1	1	3	1	\N	0	2024-05-24 00:53:23	2024-05-24 00:53:23
3	Fujairah	1	1	2	1	\N	0	2024-05-24 00:53:50	2024-05-24 00:53:50
\.
...
1	Brynne	dygukak@mailinator.com		44	Sed ex dolore dicta	2024-05-24 00:28:48	2024-05-24 00:28:48
2		admin@gmail.com				2024-05-24 00:35:37	2024-05-24 00:35:37
3		sample@gmail.com				2024-05-24 06:54:34	2024-05-24 06:54:34
\.


--
-- Data for Name: contact_us_data; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.contact_us_data (id, title, subtitle, button_text, address, phone, email, facebook_link, twitter_link, instagram_link, pinterest_link, linkedin_link, created_at, updated_at, map_url) FROM stdin;
1	Do You Have Any Questions?	It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it	CONTACT US	123, Lorem Ipsum, Street no	+1 (743) 124-7457	admin@gmail.com	#	#	#	#	#	2024-05-24 00:26:35	2024-05-24 00:27:37	https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14449.981861674376!2d55.25688921233106!3d25.1198688709261!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f6976ed4766a3%3A0xb2b2d7132a5134a8!2sDubai%20Hills%20Estate!5e0!3m2!1sen!2sin!4v1715843392141!5m2!1sen!2sin
\.
...
1	UAE	+971	971	1	2024-05-24 00:49:09	\N	0
2	America	+1	1	0	2024-05-24 00:50:10	\N	1
\.
...
COPY public.coupon (coupon_id, coupon_title, coupon_description, coupon_end_date, coupon_amount, coupon_minimum_spend, coupon_maximum_spend, coupon_usage_percoupon, coupon_usage_perx, coupon_usage_peruser, coupon_created_date, coupon_vender_id, coupon_code, coupon_status, individual_use, amount_type, created_at, updated_at, applied_to, start_date, minimum_amount, image, policy, other_documents, outlet_id, offer_label, coupon_price, saved_price) FROM stdin;
\.
...
--
-- Data for Name: coupon_image; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.coupon_image (id, coupon_id, coupon_banner, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: coupon_order; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.coupon_order (id, order_no, customer_id, outlet_id, coupon_id, order_date, created_at, updated_at, coupon_code, earned, status) FROM stdin;
\.
...
COPY public.events (id, name, amount, status, knowmore, rewards, country_id, state_id, city_id, location, latitude, longitude, deleted, event_datetime, total_participants, applied_participants, created_at, updated_at, image) FROM stdin;
\.
...
COPY public.home_banners (id, subtitle, title, button_text, button_address, banner_image_path, created_at, updated_at) FROM stdin;
1	Welcome to ShowOff	Simplify Your Life, Amplify Your Impact	Explore Now	\N	to9ezSoldoB73ovAKQgyZ4f9k6nzm4uD27TsUdjc.jpg	2024-05-24 00:21:55	2024-05-24 00:21:55
2	What's New	Unleashing Potential, Creating Impact	Explore Now	\N	N3Hn5ildRkWOkzr8E79rbowb5AO3yjStS0QXb13L.jpg	2024-05-24 00:23:24	2024-05-24 00:23:24
\.


--
-- Data for Name: home_page_about_data; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.home_page_about_data (id, image, title, subtitle, button_text, button_href, created_at, updated_at, video_link) FROM stdin;
1	5qjwbkAjtaN190HVP1dn1gMbxNBxHDjnhbkvH4uX.jpg	The Leading Listing Marketplace.	Duis pulvinar metus elit, ut aliquam est sollicitudin finibus. Integer lobortis est interdum. Suspendisse nunc est, varius quis fringilla ac, commodo a ante. Praesent non elit cursus, aliquam sapien quis, dictum tortor.	Visit Now		2024-05-24 00:35:03	2024-05-24 00:35:03	https://www.youtube.com/watch?v=0O2aH4XLbto
\.
...
COPY public.likes (id, user_id, product_id, coupon_id, vendor_id, type, created_at, updated_at) FROM stdin;
\.
...
359	2023_12_13_115400_create_provider_registration	1
360	2023_12_13_131205_change_provider_register_add_more	1
361	2023_12_13_134443_change_provider_register_add_more_details	1
362	2023_12_14_043507_change_provider_register_add_username	1
363	2023_12_14_045823_create_coupon_usage	1
364	2023_12_14_081126_change_video_add_videotype	1
365	2023_12_14_110356_create_coupon_upload_videos	1
366	2023_12_14_113116_create_coupon_unlock_videos	1
367	2023_12_15_040937_change_review_add_new	1
368	2023_12_15_061011_change_vendor_details_remove_fireign	1
369	2023_12_19_062732_change_provide_register_add_more_deta	1
370	2023_12_19_084253_change_app_banners_add_vendor_id	1
371	2024_01_17_085738_age	1
372	2024_01_17_092712_gender	1
373	2024_02_01_114011_likes	1
374	2024_02_06_035305_coupon_order	1
375	2024_02_06_085807_coupon_code	1
376	2024_02_09_045307_video_views	1
377	2024_02_10_044054_coupon_id	1
378	2024_02_10_054203_status	1
379	2024_03_23_045026_banner_image_ar	1
380	2024_03_25_071957_video_downloads	1
381	2024_03_25_094700_coupon_image	1
382	2024_04_05_110832_email_verified	1
383	2024_04_06_043756_state_id	1
384	2024_04_12_051238_verified_date	1
385	2024_04_12_100401_inactive_days	1
386	2024_04_29_054521_coupon_price	1
387	2024_04_29_094410_image	1
388	2024_04_30_054126_ref_code	1
389	2024_04_30_062623_ref_by	1
390	2024_05_02_090426_create_operating_hours_table	1
391	2024_05_08_130303_update_operating_hours_table	1
392	2024_05_08_150359_add_columns_to_services_table	1
393	2024_05_19_114237_create_home_banners_table	1
394	2024_05_19_154141_create_testimonials_table	1
395	2024_05_19_163532_create_teams_table	1
396	2024_05_19_204957_create_home_page_about_data_table	1
397	2024_05_19_213803_create_contact_us_data_table	1
398	2024_05_20_113729_add_rating_to_testimonials_table	1
399	2024_05_20_175430_add_video_link_to_home_page_about_data_table	1
400	2024_05_20_182051_add_map_url_contact_us_data	1
401	2024_05_20_184018_increase_map_url_length_in_contact_us_data_table	1
402	2024_05_20_184204_increase_review_length_in_testimonials_table	1
403	2024_05_20_230146_add_map_url_in_users_table	1
404	2024_05_21_140358_create_our_customers_table	1
405	2024_05_22_081444_add_loyalty_points_and_coupon_in_users_table	1
406	2024_05_22_084735_create_subscriptions_table	1
407	2024_05_22_093413_add_subscription_services_and_duration_in_users_table	1
408	2024_05_22_113333_add_coupon_used_in_users_table	1
409	2024_05_22_114825_add_subscription_started_in_users_table	1
410	2024_05_22_143622_create_service_obtains_table	1
411	2024_05_23_102916_change_coupon_used_type_in_users_table	1
412	2024_05_23_105852_create_wishlists_table	1
413	2024_05_23_141219_create_privacy_policies_table	1
414	2024_05_23_141634_create_term_conditions_table	1
415	2024_05_23_192516_add_reviews_in_service_obtains	1
416	2024_05_23_211914_add_qr_code_column_in_users_table	1
\.
...
1	Head	2024-05-24 00:18:09	\N
2	Upper Body	2024-05-24 00:18:09	\N
3	Lower Body	2024-05-24 00:18:09	\N
4	Footwear	2024-05-24 00:18:09	\N
5	Makeup	2024-05-24 00:18:09	\N
6	Accessories	2024-05-24 00:18:09	\N
\.
...
COPY public.operating_hours (id, vendor_id, day_of_week, open_time, close_time, created_at, updated_at) FROM stdin;
1	2	Monday	12:00 PM	9:00 PM	2024-05-24 00:59:14	2024-05-24 00:59:14
2	2	Tuesday	12:00 PM	9:00 PM	2024-05-24 00:59:14	2024-05-24 00:59:14
3	2	Wednesday	12:00 PM	9:00 PM	2024-05-24 00:59:14	2024-05-24 00:59:14
4	2	Thursday	12:00 PM	9:00 PM	2024-05-24 00:59:14	2024-05-24 00:59:14
5	2	Friday	12:00 PM	9:00 PM	2024-05-24 00:59:14	2024-05-24 00:59:14
6	2	Saturday	12:00 PM	9:00 PM	2024-05-24 00:59:14	2024-05-24 00:59:14
7	2	Sunday	12:00 PM	9:00 PM	2024-05-24 00:59:14	2024-05-24 00:59:14
8	3	Monday	12:00 PM	9:00 PM	2024-05-24 01:01:43	2024-05-24 01:01:43
9	3	Tuesday	12:00 PM	9:00 PM	2024-05-24 01:01:43	2024-05-24 01:01:43
10	3	Wednesday	12:00 PM	9:00 PM	2024-05-24 01:01:43	2024-05-24 01:01:43
11	3	Thursday	12:00 PM	9:00 PM	2024-05-24 01:01:43	2024-05-24 01:01:43
12	3	Friday	12:00 PM	9:00 PM	2024-05-24 01:01:43	2024-05-24 01:01:43
13	3	Saturday	12:00 PM	9:00 PM	2024-05-24 01:01:43	2024-05-24 01:01:43
14	3	Sunday	12:00 PM	9:00 PM	2024-05-24 01:01:43	2024-05-24 01:01:43
15	4	Monday	12:00 PM	7:00 PM	2024-05-24 01:05:00	2024-05-24 01:05:00
16	4	Tuesday	12:00 PM	7:00 PM	2024-05-24 01:05:00	2024-05-24 01:05:00
17	4	Wednesday	12:00 PM	7:00 PM	2024-05-24 01:05:00	2024-05-24 01:05:00
18	4	Thursday	12:00 PM	7:00 PM	2024-05-24 01:05:00	2024-05-24 01:05:00
19	4	Friday	12:00 PM	7:00 PM	2024-05-24 01:05:00	2024-05-24 01:05:00
20	4	Saturday	12:00 PM	7:00 PM	2024-05-24 01:05:00	2024-05-24 01:05:00
21	4	Sunday	12:00 PM	7:00 PM	2024-05-24 01:05:00	2024-05-24 01:05:00
22	5	Monday	12:00 PM	8:00 PM	2024-05-24 01:12:02	2024-05-24 01:12:02
23	5	Tuesday	12:00 PM	8:00 PM	2024-05-24 01:12:02	2024-05-24 01:12:02
24	5	Wednesday	12:00 PM	8:00 PM	2024-05-24 01:12:02	2024-05-24 01:12:02
25	5	Thursday	12:00 PM	8:00 PM	2024-05-24 01:12:02	2024-05-24 01:12:02
26	5	Friday	12:00 PM	8:00 PM	2024-05-24 01:12:02	2024-05-24 01:12:02
27	5	Saturday	12:00 PM	8:00 PM	2024-05-24 01:12:02	2024-05-24 01:12:02
28	5	Sunday	12:00 PM	8:00 PM	2024-05-24 01:12:02	2024-05-24 01:12:02
29	6	Monday	12:00 PM	8:00 PM	2024-05-24 01:17:21	2024-05-24 01:17:21
30	6	Tuesday	12:00 PM	8:00 PM	2024-05-24 01:17:21	2024-05-24 01:17:21
31	6	Wednesday	12:00 PM	8:00 PM	2024-05-24 01:17:21	2024-05-24 01:17:21
32	6	Thursday	12:00 PM	8:00 PM	2024-05-24 01:17:21	2024-05-24 01:17:21
33	6	Friday	12:00 PM	8:00 PM	2024-05-24 01:17:21	2024-05-24 01:17:21
34	6	Saturday	12:00 PM	8:00 PM	2024-05-24 01:17:21	2024-05-24 01:17:21
35	6	Sunday	12:00 PM	8:00 PM	2024-05-24 01:17:21	2024-05-24 01:17:21
36	10	Monday	12:00 PM	8:00 PM	2024-05-24 16:05:53	2024-05-24 16:05:53
37	10	Tuesday	12:00 PM	8:00 PM	2024-05-24 16:05:53	2024-05-24 16:05:53
38	10	Wednesday	12:00 PM	8:00 PM	2024-05-24 16:05:53	2024-05-24 16:05:53
39	10	Thursday	12:00 PM	8:00 PM	2024-05-24 16:05:53	2024-05-24 16:05:53
40	10	Friday	12:00 PM	8:00 PM	2024-05-24 16:05:53	2024-05-24 16:05:53
41	10	Saturday	12:00 PM	8:00 PM	2024-05-24 16:05:53	2024-05-24 16:05:53
42	10	Sunday	12:00 PM	8:00 PM	2024-05-24 16:05:53	2024-05-24 16:05:53
43	11	Monday	12:00 PM	12:00 AM	2024-05-24 16:22:35	2024-05-24 16:22:35
44	11	Tuesday	12:00 PM	12:00 AM	2024-05-24 16:22:35	2024-05-24 16:22:35
45	11	Wednesday	12:00 PM	12:00 AM	2024-05-24 16:22:35	2024-05-24 16:22:35
46	11	Thursday	12:00 PM	12:00 AM	2024-05-24 16:22:35	2024-05-24 16:22:35
47	11	Friday	12:00 PM	12:00 AM	2024-05-24 16:22:35	2024-05-24 16:22:35
48	11	Saturday	12:00 PM	12:00 AM	2024-05-24 16:22:35	2024-05-24 16:22:35
49	11	Sunday	12:00 PM	12:00 AM	2024-05-24 16:22:35	2024-05-24 16:22:35
50	12	Monday	12:00 PM	3:00 PM	2024-05-24 16:34:11	2024-05-24 16:34:11
51	12	Tuesday	3:00 PM	12:00 PM	2024-05-24 16:34:11	2024-05-24 16:34:11
52	12	Wednesday	12:00 PM	3:00 PM	2024-05-24 16:34:11	2024-05-24 16:34:11
53	12	Thursday	3:00 PM	3:00 PM	2024-05-24 16:34:11	2024-05-24 16:34:11
54	12	Friday	12:00 PM	12:00 PM	2024-05-24 16:34:11	2024-05-24 16:34:11
55	12	Saturday	12:00 PM	3:00 PM	2024-05-24 16:34:11	2024-05-24 16:34:11
56	12	Sunday	12:00 PM	3:00 PM	2024-05-24 16:34:11	2024-05-24 16:34:11
57	13	Monday	12:00 PM	12:00 AM	2024-05-24 16:37:57	2024-05-24 16:37:57
58	13	Tuesday	12:00 AM	12:00 PM	2024-05-24 16:37:57	2024-05-24 16:37:57
59	13	Wednesday	12:00 PM	12:00 AM	2024-05-24 16:37:57	2024-05-24 16:37:57
60	13	Thursday	12:00 AM	12:00 PM	2024-05-24 16:37:57	2024-05-24 16:37:57
61	13	Friday	12:00 PM	12:00 AM	2024-05-24 16:37:57	2024-05-24 16:37:57
62	13	Saturday	12:00 AM	12:00 PM	2024-05-24 16:37:57	2024-05-24 16:37:57
63	13	Sunday	12:00 PM	12:00 AM	2024-05-24 16:37:57	2024-05-24 16:37:57
64	14	Monday	12:00 PM	5:00 PM	2024-05-24 16:41:17	2024-05-24 16:41:17
65	14	Tuesday	12:00 PM	5:00 PM	2024-05-24 16:41:17	2024-05-24 16:41:17
66	14	Wednesday	12:00 PM	5:00 PM	2024-05-24 16:41:17	2024-05-24 16:41:17
67	14	Thursday	12:00 PM	5:00 PM	2024-05-24 16:41:17	2024-05-24 16:41:17
68	14	Friday	12:00 PM	5:00 PM	2024-05-24 16:41:17	2024-05-24 16:41:17
69	14	Saturday	12:00 PM	12:00 PM	2024-05-24 16:41:17	2024-05-24 16:41:17
70	14	Sunday	12:00 PM	5:00 PM	2024-05-24 16:41:17	2024-05-24 16:41:17
71	15	Monday	12:00 PM	8:00 PM	2024-05-24 16:43:51	2024-05-24 16:43:51
72	15	Tuesday	12:00 PM	8:00 PM	2024-05-24 16:43:51	2024-05-24 16:43:51
73	15	Wednesday	12:00 PM	8:00 PM	2024-05-24 16:43:51	2024-05-24 16:43:51
74	15	Thursday	12:00 PM	8:00 PM	2024-05-24 16:43:51	2024-05-24 16:43:51
75	15	Friday	12:00 PM	8:00 PM	2024-05-24 16:43:51	2024-05-24 16:43:51
76	15	Saturday	12:00 PM	8:00 PM	2024-05-24 16:43:51	2024-05-24 16:43:51
77	15	Sunday	12:00 PM	8:00 PM	2024-05-24 16:43:51	2024-05-24 16:43:51
78	16	Monday	12:00 PM	7:00 PM	2024-05-24 16:47:11	2024-05-24 16:47:11
79	16	Tuesday	12:00 PM	5:00 PM	2024-05-24 16:47:11	2024-05-24 16:47:11
80	16	Wednesday	12:00 PM	5:00 PM	2024-05-24 16:47:11	2024-05-24 16:47:11
81	16	Thursday	12:00 PM	12:00 PM	2024-05-24 16:47:11	2024-05-24 16:47:11
82	16	Friday	12:00 PM	6:00 PM	2024-05-24 16:47:11	2024-05-24 16:47:11
83	16	Saturday	12:00 PM	5:00 PM	2024-05-24 16:47:11	2024-05-24 16:47:11
84	16	Sunday	12:00 PM	7:00 PM	2024-05-24 16:47:11	2024-05-24 16:47:11
85	17	Monday	12:00 PM	6:00 PM	2024-05-24 16:48:42	2024-05-24 16:48:42
86	17	Tuesday	12:00 PM	12:00 PM	2024-05-24 16:48:42	2024-05-24 16:48:42
87	17	Wednesday	12:00 PM	6:00 PM	2024-05-24 16:48:42	2024-05-24 16:48:42
88	17	Thursday	12:00 PM	12:00 PM	2024-05-24 16:48:42	2024-05-24 16:48:42
89	17	Friday	12:00 PM	6:00 PM	2024-05-24 16:48:42	2024-05-24 16:48:42
90	17	Saturday	12:00 PM	6:00 PM	2024-05-24 16:48:42	2024-05-24 16:48:42
91	17	Sunday	12:00 PM	6:00 PM	2024-05-24 16:48:42	2024-05-24 16:48:42
\.
...
--
-- Data for Name: our_customers; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.our_customers (id, name, image, created_at, updated_at) FROM stdin;
1	Zachery	h5RvGtU0IanhYdnruW6EIeDzM6A0pJEf8lKiT6LA.png	2024-05-24 00:37:13	2024-05-24 00:37:13
2	Colin Prince	cBsiHS7gNKvGCG0OR2j5YN8rZgcygV9zqh41BKZZ.png	2024-05-24 00:37:27	2024-05-24 00:37:27
3	Sandra Hammond	ykLl4MQbTUeWi5pXSfMi4JRbeFZG6ubeqjLpOlvR.png	2024-05-24 00:37:43	2024-05-24 00:37:43
4	Igor Cooley	ktcw7XYWCNacD43xOEx8CAJt2TcjlIClABfLJBeK.png	2024-05-24 00:38:05	2024-05-24 00:38:05
5	Fallon Mayo	2uA0vvbEPgA34szeEWmeNw3vI8ssdaIzYJ3QtqvU.png	2024-05-24 00:38:28	2024-05-24 00:38:28
\.
...
1	2	eG6dM4CXpyRRzxYFGgMR7bHnnJsnwcDOVAdY0LEO.jpg	1	0	2024-05-24 00:59:14	2024-05-24 00:59:14
2	2	KsziJxAnqJwOxibPw8XFqUGuGCzvfNWKcBFd9YfA.jpg	1	0	2024-05-24 00:59:14	2024-05-24 00:59:14
3	2	587FmziCJlK3hWWYir9648Szk1Ew9UtkD6LAfwiX.jpg	1	0	2024-05-24 00:59:14	2024-05-24 00:59:14
4	3	W6EXgOdUCpV9oB0z7fYsn7KBqwtw5z0Uk8q0R9k1.jpg	1	0	2024-05-24 01:01:43	2024-05-24 01:01:43
5	3	hNyRqDlLFHTFXrq47vbG5QXe5vY01O7ftsgd7f3l.jpg	1	0	2024-05-24 01:01:43	2024-05-24 01:01:43
6	3	Ai8xOvIzL3aNvnfV4M0Pu7k0NOVk47NQaUutP0bm.jpg	1	0	2024-05-24 01:01:43	2024-05-24 01:01:43
7	4	TCRXC2PEZ18PguZgqJoSn80TwBSw55iimsch00SE.jpg	1	0	2024-05-24 01:05:00	2024-05-24 01:05:00
8	4	W8zmpWj80FhlCWUKw1CbVr81P4b18I4ik8ToJCAR.jpg	1	0	2024-05-24 01:05:00	2024-05-24 01:05:00
9	4	WhmdOC3MiomVB8qlRPHiWz3129LEbCHS6L5sOyNy.jpg	1	0	2024-05-24 01:05:00	2024-05-24 01:05:00
10	4	oDWauf1y3j2MKu4yHCn3axqCeZMyAxgb9nCRyxzP.jpg	1	0	2024-05-24 01:05:43	2024-05-24 01:05:43
11	4	023fNjSN1aGyVGWqAzFdZzbR7jCJ11rKo4ESEeGC.jpg	1	0	2024-05-24 01:05:43	2024-05-24 01:05:43
12	4	c4pu2RuBMgi4hoh6Kwou1v2HuW4gGsbrPTRwjNIW.jpg	1	0	2024-05-24 01:05:43	2024-05-24 01:05:43
13	3	JrAYUw0mYYozfRAOqIntXWOM64kN2FrQ94Kcqqgt.jpg	1	0	2024-05-24 01:06:35	2024-05-24 01:06:35
14	3	JYZ7b8Toc8ZfxDEDenqTP0iawTjimWBPWTGZly9s.jpg	1	0	2024-05-24 01:06:35	2024-05-24 01:06:35
15	3	mIXfsX47TgCvoRC8K2b8SuuqriOvvz91N140owp2.jpg	1	0	2024-05-24 01:06:35	2024-05-24 01:06:35
16	5	emWWRbhzh6ck3efa4T9NGDKTaJv6Ej3QSav36ZIN.jpg	1	0	2024-05-24 01:12:02	2024-05-24 01:12:02
17	5	FkLDELva1qHI2twlZRRYxJk4qCYMNEb9nl4KNlXW.jpg	1	0	2024-05-24 01:12:02	2024-05-24 01:12:02
18	5	O1SpV2dB9ajwX0Ltd2NYGl3q2VTl833L6O5KAsEC.jpg	1	0	2024-05-24 01:12:02	2024-05-24 01:12:02
19	6	URa33BAlyZaxjQSJxTvbemhfflnnX7YYl6dqC2Lo.jpg	1	0	2024-05-24 01:17:21	2024-05-24 01:17:21
20	6	xykeq8v7CJgmzqfidUZ2Ak4ENBY8iKhqTh9oKeuQ.jpg	1	0	2024-05-24 01:17:21	2024-05-24 01:17:21
21	6	OmURQdlJL3DAsuBcVNJ4wNfSOFFBXD011JHRXmQS.jpg	1	0	2024-05-24 01:17:21	2024-05-24 01:17:21
22	5	PiqeYPt5iqMVpL4uQauz2XJcDWCG9y34n3TDRFMx.jpg	1	0	2024-05-24 07:01:42	2024-05-24 07:01:42
23	5	RU7LHokUebWSWGpXnwFGKF1ih0VJEK1cAlar4K9P.jpg	1	0	2024-05-24 07:01:42	2024-05-24 07:01:42
24	5	rKic3xjmhnQw1lrJmTSJrDykHkxHuZevw44SE3Nt.jpg	1	0	2024-05-24 07:01:42	2024-05-24 07:01:42
25	10	lHnA9jPfHUGvWPwzcp2sblwkrLaa9LxeFU7pnl7q.jpg	1	0	2024-05-24 16:05:53	2024-05-24 16:05:53
26	10	vgXEwoyZ9B41knKVfkMRuk72HgtC9C1sgn0sFosd.jpg	1	0	2024-05-24 16:05:53	2024-05-24 16:05:53
27	10	jEobfrFTeLntiOWfzkVA5Fj4sGebSRox4qTbZ1IL.jpg	1	0	2024-05-24 16:05:53	2024-05-24 16:05:53
28	11	AV2Yb60oUXGFEZqKgR2wJqHAVufZ2D5HKklvhtAY.jpg	1	0	2024-05-24 16:22:35	2024-05-24 16:22:35
29	11	dmFwhLazY3PxmTnurODUFLBzxXHWfthRYTX3Yhvg.jpg	1	0	2024-05-24 16:22:35	2024-05-24 16:22:35
30	11	Ex5n7h5wPL7ipYeEGXH2IcaN7JkL82dfomd1lT8F.jpg	1	0	2024-05-24 16:22:35	2024-05-24 16:22:35
31	11	4uxjIFoksboFBI9fCXUCfcBSwkDxCQIl5hFLAe7e.jpg	1	0	2024-05-24 16:23:34	2024-05-24 16:23:34
32	11	FLXA8zUTT0gWnvNLtjDwyuavK2qHwGODkDyyLxW7.jpg	1	0	2024-05-24 16:23:34	2024-05-24 16:23:34
33	11	7u1I42HcKREWKeniQOabsAdY2Nble4eFxBefFwZf.jpg	1	0	2024-05-24 16:23:34	2024-05-24 16:23:34
34	12	Zh0F5ReUSCcVh4t7sShNysrXW9pqKNsAk3wfpJrZ.jpg	1	0	2024-05-24 16:34:11	2024-05-24 16:34:11
35	12	8ODmmBKCFMAu4olzkuJQkp86GRuiA0bdQ3pjAfBb.jpg	1	0	2024-05-24 16:34:11	2024-05-24 16:34:11
36	12	gODM3AYUh9CIZGYr3q6aeMZRbOUmtAf1Bryj3rqr.jpg	1	0	2024-05-24 16:34:11	2024-05-24 16:34:11
37	13	y9eaTYnSu7a4jWEHmMKsEh4zVPg9wId6jEAQXV48.jpg	1	0	2024-05-24 16:37:57	2024-05-24 16:37:57
38	13	JZmv3LxLiAJ4SkJSXbwaifvXHHRfDGw1rIfbYoZP.jpg	1	0	2024-05-24 16:37:57	2024-05-24 16:37:57
39	13	MW54dhVN8tL6z7bAb6TdtZd775B3ZASCvt26kaDV.jpg	1	0	2024-05-24 16:37:57	2024-05-24 16:37:57
40	14	TzKDIEpZo1uEKJgENY2FII7o2eD4LPhvYh4x0gXp.jpg	1	0	2024-05-24 16:41:17	2024-05-24 16:41:17
41	14	M2YGf3di4ABXvyWgtZWCbr6WwefHfCLUnVIU8St8.jpg	1	0	2024-05-24 16:41:17	2024-05-24 16:41:17
42	14	qEYMhJ1IiKO2BR1uFaqf16nRFRsyDwES62SyFN7f.jpg	1	0	2024-05-24 16:41:17	2024-05-24 16:41:17
43	15	I3uh1yb8KOcfcNf4q3qgzy6bJB5iSnMIveYosqtH.jpg	1	0	2024-05-24 16:43:51	2024-05-24 16:43:51
44	15	vzgJr51Ia4hLuhc81Zwv21UScsTsuc5aPRH63o0c.jpg	1	0	2024-05-24 16:43:51	2024-05-24 16:43:51
45	15	H36eODRuYoKWOSXSmsCoIm4Pm1OYY723RKa6PF3a.jpg	1	0	2024-05-24 16:43:51	2024-05-24 16:43:51
46	16	h1ikvmVxcNl3xFi0GgbREvsJjAYSmFyUKSh9lcHA.jpg	1	0	2024-05-24 16:47:11	2024-05-24 16:47:11
47	16	ZA8k44cGR4xGrR7hYuNZOmubPBFXVNHQhsMAfmYN.jpg	1	0	2024-05-24 16:47:11	2024-05-24 16:47:11
48	16	A1UX3q1pHhU4do8apV6zn0yUNB3k4fAh2GwRD7Uu.jpg	1	0	2024-05-24 16:47:11	2024-05-24 16:47:11
49	17	91fP1NtJWNHzLOAGyLItab9UymB6S7UYEoXniGgv.jpg	1	0	2024-05-24 16:48:42	2024-05-24 16:48:42
50	17	xd1kydW0oZTaa7JYwIG4KgVU6Qg0ZWyJKLF8pATS.jpg	1	0	2024-05-24 16:48:42	2024-05-24 16:48:42
51	17	7ybKWOiVjeVLrjb2q69pGYKtpWsWGhyMyntjlSyC.jpg	1	0	2024-05-24 16:48:42	2024-05-24 16:48:42
52	14	t3zVuPSokAB8umlDe9OlCHg9NyLjgeMnWqacZUyY.jpg	1	0	2024-05-24 17:12:01	2024-05-24 17:12:01
53	14	IhqFfv4c55LYiGWFiwhjcv7cL9kRTJCaEbJNsRww.jpg	1	0	2024-05-24 17:12:01	2024-05-24 17:12:01
54	14	OocBkLZfX7dng43e3ce0z2IuYr8PrZib6N9pacUZ.jpg	1	0	2024-05-24 17:12:01	2024-05-24 17:12:01
\.
...
COPY public.privacy_policies (id, title, subtitle, parah_1, parah_2, created_at, updated_at) FROM stdin;
1	We collect various types of information in connection with the Services	Don't worry your data is secure	Welcome to Show Of. We value your privacy and are committed to protecting your personal information. This Privacy Policy outlines our practices regarding the collection, use, and disclosure of your information when you use our services, website, and applications (collectively, the “Services”). By accessing or using our Services, you agree to the terms of this Privacy Policy.	Service Providers: We may share your information with third-party service providers who perform services on our behalf, such as payment processing, data analysis, email delivery, and hosting services. These service providers have access to your personal information only to perform specific tasks and are obligated to protect your information.\r\n\r\nOur Services are not intended for children under the age of 13. We do not knowingly collect or solicit personal information from children under 13. If we become aware that we have collected personal information from a child under 13, we will take steps to delete that information promptly. If you believe we might have any information from or about a child under 13, please contact us.	2024-05-24 00:46:24	2024-05-24 15:27:10
\.
...
COPY public.provider_registration (id, name, email, phone, trade_license, location, latitude, longitude, banners, status, otp, created_at, updated_at, dial_code, password, username, about_me, country_id, city_id, main_category_id, image, email_verified, state_id) FROM stdin;
\.
...
--
-- Data for Name: service_obtains; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.service_obtains (id, user_id, vendor_id, service_id, created_at, updated_at, reviews, rating, reviewed_at) FROM stdin;
1	8	5	6	2024-05-24 07:03:30	2024-05-24 07:08:13	There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which.	3	2024-05-24 07:08:13
\.
...
COPY public.services (id, name, image, active, deleted, created_at, updated_at, background_image, slug, sort_order, vendor_id, price, description) FROM stdin;
1	Shape Hair Cut	services/MJkPWDzfKwhS9HloQBecm5vPZgdOdLhRybJ2tXNc.jpg	1	0	2024-05-24 01:08:31	2024-05-24 01:08:31	\N		0	4	299.00	THis is daid iasdahd adia akshda dasdhad ihad aidhaidhs
2	Fade Cutting	services/kVvuUbrH97Mvn6xymFc8E66kU52GdzwqCwKCk70m.jpg	1	0	2024-05-24 01:09:19	2024-05-24 01:09:19	\N		0	3	500.00	aiouasi iaosud aoisd uaiosdu ioasdu aisudioas dioasd ioausd iuasioduas oiu
3	Poppy Car Wash	services/4s7cfkMaoJVMe3sekGiDYZ7tsWAtKRVbNBOhtfDs.jpg	1	0	2024-05-24 01:18:25	2024-05-24 01:18:25	\N		0	6	199.00	Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry
4	Half Wash	services/9q6Sj1QOXLX5KvTMxtT1Q2JfFoGBGcGz8TyPFLP5.jpg	1	0	2024-05-24 01:19:15	2024-05-24 01:19:15	\N		0	6	999.00	Lorem Ipsum is simply dummy text of the printing and typesetting
5	Special Tyre Wash	services/shdtoVRIIQp4qGFVwMeEss0bADbdFA4OpMYf2w0T.jpg	1	0	2024-05-24 01:19:55	2024-05-24 01:19:55	\N		0	6	600.00	WE wash tryers very carefully .
6	Shera Cut	services/8jXGheBM0a2mHMZrhjpuEgDQVWbNPgq7NYupO6Yf.jpg	1	0	2024-05-24 01:20:46	2024-05-24 01:20:46	\N		0	5	1999.00	Lorem Ipsum is simply dummy text of theey of type and scrambled it to make a type specimen book.
7	Fire Cutting	services/Vrbc9mJJz17vMp8qT8xY8PNLMmgkJ0iBjYVbMcYM.jpg	1	0	2024-05-24 01:21:44	2024-05-24 01:21:44	\N		0	2	899.00	We offer new style fire cutrting
8	Car Body Wash	services/QcofFY0nlGmFlJUzWKtCikhJJeP4Gw6m4CQ5X16B.jpg	1	0	2024-05-24 16:51:01	2024-05-24 16:51:01	\N		0	17	450.00	We are offer you the service the wash the exterior of you car
9	Spray Wash	services/FWxDOoLtiV7TIME5rwHwJtombGrIcPQ7VB4HpZPJ.jpg	1	0	2024-05-24 16:51:58	2024-05-24 16:51:58	\N		0	16	799.00	In this service we wash you cars with a soap spary gun
10	Hair Styling	services/6f23JDTkSWXI1GKRw9O6yJjBHOAFLenZOgckQ64m.jpg	1	0	2024-05-24 16:54:19	2024-05-24 16:54:19	\N		0	15	299.00	We offer every type of hair styling.
11	Fade Cutting	services/9iwakNpduCxDaTtShQEknhJEVULBLfGEgAGJvMpU.jpg	1	0	2024-05-24 16:56:16	2024-05-24 16:56:16	\N		0	14	499.00	We offer all types of fade hair cutting
12	Hair Coloring	services/Ud3SLaypEewontEipfgmcsr8Pwak3kI0Pb2TpJ9Y.jpg	1	0	2024-05-24 16:57:02	2024-05-24 16:57:02	\N		0	13	699.00	We offer all types of hair cutting and hair shading
13	Trimming	services/MiumvJ40eVlBbjqDAtnEUArbYpWHZxTToqjStIrM.jpg	1	0	2024-05-24 16:58:22	2024-05-24 16:58:22	\N		0	11	259.00	We offer new style hair trimming
14	New Look Hair Treatment	services/LaiCvTiHMNq0dXFamKFmKJVVibViMbGmdDAWl0TR.jpg	1	0	2024-05-24 16:59:22	2024-05-24 16:59:22	\N		0	10	1299.00	We offer all type of hair cutting and hair treatments.
\.
...
COPY public.settings (id, admin_commission, shipping_charge, created_at, updated_at, tax_percentage, moda_commission, inactive_days) FROM stdin;
1	0	0	\N	\N	0	0	0
\.
...
2	Sharjah	1	1	1	\N	0	2024-05-24 00:51:03	2024-05-24 00:51:03
3	Dubai	1	1	1	\N	0	2024-05-24 00:51:15	2024-05-24 00:51:15
4	California	0	2	1	1	1	2024-05-24 00:51:44	2024-05-24 11:22:36
1	Las Vegas	0	2	1	1	1	2024-05-24 00:50:43	2024-05-24 11:22:47
\.
...
COPY public.subscriptions (id, name, price, duration, services, created_at, updated_at) FROM stdin;
1	Gold	199	180	25	2024-05-24 00:42:40	2024-05-24 00:42:40
2	Silver	49	30	10	2024-05-24 00:43:16	2024-05-24 00:43:16
\.
...
COPY public.teams (id, name, designation, profile_image, facebook_link, twitter_link, linkedin_link, created_at, updated_at) FROM stdin;
1	Ali Anjam	Front-End Developer	3s3070XxLPTeH1blrQFMS8zpbCyc1urjUZ58ZxMy.jpg	#	#	#	2024-05-24 00:39:23	2024-05-24 00:39:23
2	Rhonda	CEO	C9x5Kp4IBxik3DGB3uTNojXgThvkk13EUmlKPJqI.jpg	#	#	#	2024-05-24 00:39:57	2024-05-24 00:39:57
3	Areeb Ch	Back-End Developer	4uhMNl5Vpx7gkmjXbqY0sB1aTCHBxWKT19G0DVqn.jpg	#	#	#	2024-05-24 00:40:16	2024-05-24 00:40:16
4	Chaim	Full-Stack Developer	QbfVtB4zgktLtJruOfWWLEG5XuZJr2f7mFJuJh8o.jpg	#	#	#	2024-05-24 00:40:39	2024-05-24 00:40:39
5	Picaas	Graphic Designer	HJHJj3xOYgqd3AWmgMBM940FFPCL32acYgkBfGml.jpg	#	#	#	2024-05-24 00:41:06	2024-05-24 00:41:06
\.
...
COPY public.temp_users (id, name, email, dial_code, phone, phone_verified, active, email_verified, password, email_verified_at, role, first_name, last_name, user_image, user_phone_otp, user_email_otp, user_device_token, user_device_type, user_access_token, firebase_user_key, device_cart_id, created_at, updated_at, country_id, user_name, dob, skill_level, step, gender, age, city_id) FROM stdin;
\.


--
-- Data for Name: term_conditions; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.term_conditions (id, title, subtitle, parah_1, parah_2, created_at, updated_at) FROM stdin;
1	Welcome to Show Of. By accessing or using our services, website, and applications	What's New	You agree to comply with and be bound by these Terms and Conditions. Please read these terms carefully. If you do not agree with any part of these terms, you must not use our Services.	Account Registration: To access certain features of our Services, you may be required to register for an account. You agree to provide accurate, current, and complete information during the registration process and to update such information as necessary to keep it accurate, current, and complete. You are responsible for safeguarding your account information and for any activities or actions under your account.\r\n\r\nTermination: We reserve the right to terminate or suspend your account and access to our Services, without prior notice or liability, for any reason, including if you breach these Terms and Conditions.	2024-05-24 00:47:45	2024-05-24 15:34:22
\.
...
COPY public.testimonials (id, name, review, profile_image, created_at, updated_at, rating) FROM stdin;
1	Evangeline	Duis pulvinar metus elit, ut aliquam est sollicitudin finibus. Integer lobortis est interdum. Suspendisse nunc est, varius quis fringilla ac, commodo a Praesent non elit cursus, aliquam sapien quis, dictum tortor. Vestibulum eu nisl est.	6O6xeDsVYIXNBDKHF6p0P2ZtmpWs0cpFDryx2yOI.jpg	2024-05-24 00:30:22	2024-05-24 00:30:39	4
2	Serina	Duis pulvinar metus elit, ut aliquam est sollicitudin finibus. Integer lobortis est interdum. Suspendisse nunc est, varius quis fringilla ac, commodo a Praesent non elit cursus, aliquam sapien quis, dictum tortor. Vestibulum eu nisl est.	Dgpo5mYJ4ouIZUjndsUshD6rWhSQjmlGmJTmJ1dA.jpg	2024-05-24 00:31:00	2024-05-24 00:31:00	5
3	Marvin	Duis pulvinar metus elit, ut aliquam est sollicitudin finibus. Integer lobortis est interdum. Suspendisse nunc est, varius quis fringilla ac, commodo a Praesent non elit cursus, aliquam sapien quis, dictum tortor. Vestibulum eu nisl est.	wTbzM05ayK8LPQEqZF1lL6uKPvTKSnSAJ2JtZbDX.jpg	2024-05-24 00:31:20	2024-05-24 00:32:50	5
4	Naomi 123	Duis pulvinar metus elit, ut aliquam est sollicitudin finibus. Integer lobortis est interdum. Suspendisse nunc est, varius quis fringilla ac, commodo a Praesent non elit cursus, aliquam sapien quis, dictum tortor. Vestibulum eu nisl est.	NeNs8Tjb0ITLA1ouxDzxpu9ASubn4X40oY8UHogC.jpg	2024-05-24 00:31:39	2024-05-24 07:06:30	3
\.
...
COPY public.users (id, name, email, dial_code, phone, phone_verified, password, email_verified_at, role, first_name, last_name, user_image, user_phone_otp, user_device_token, user_device_type, user_access_token, firebase_user_key, remember_token, created_at, updated_at, country_id, state_id, city_id, area, active, deleted, display_name, business_name, email_verified, user_email_otp, dob, vendor, store, previllege, about_me, verified, designation_id, is_private_profile, user_name, gender, website, wallet_amount, password_reset_code, password_reset_time, password_reset_otp, privacy_id, send_notification, mute_message, commission, public_business_info, facebook_url, instagram_url, linkedin_url, is_social, twitter_url, tiktok_url, user_type_id, activity_type_id, commercial_license, commercial_reg_no, associated_license, res_dial_code, res_phone, address, business_type_id, admin_commission_perc, residence_no, nationality, rating, rated_users, banner_image, hide_profile, temp_dial_code, temp_mobile, skill_level, step, membership_type, membership_expiry, trade_license, business_type, location, latitude, longitude, main_category_id, age, verified_date, ref_code, map_url, loyalty_points, coupon, subscription_services, subscription_duration, subscription_id, coupon_used, subscription_end_at, qr_code) FROM stdin;
2	Leslie Owen	citup@mailinator.com	971	789812312	1	$2y$10$hT4.nbgM35J.Aik/PoYX9eAjsBePzNKcF1C3ED6aGkmZypyaOkMHi	\N	4			Kia1kJtzpAE5U0qO7UjMbrzg33BHzp8HvvJ2igTn.jpg	\N	\N	\N	\N	\N	\N	\N	\N	1	2	3	0	1	0	\N	Ajmal Beauty Saloon	0	\N	\N	0	0	0	Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.	0	\N	0	Leslie Owen	1	https://vsco.co/tamara-tomaa/gallery	0	\N	\N	\N	999999	1	0	\N	0	\N	\N	\N	0	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	0	\N	\N	0	0	\N	0			\N	0	0	\N	\N	saloon		\N	\N	0	0	\N	\N	https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14449.981861674376!2d55.25688921233106!3d25.1198688709261!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f6976ed4766a3%3A0xb2b2d7132a5134a8!2sDubai%20Hills%20Estate!5e0!3m2!1sen!2sin!4v1715843392141!5m2!1sen!2sin	0	\N	\N	\N	\N	0	\N	\N
4	Gary Schwartz	tobu@mailinator.copy	971	21897312	1	$2y$10$u1tgSuqD3iRGIp70ldM4we8qdc2I5v.5IcW1cFHmyE.bK5nwzM9w6	\N	4			fRRmmLpkH42dtRTucd6JNDW8clk8iwSy56ydw5a9.jpg	\N	\N	\N	\N	\N	\N	\N	\N	1	3	2	0	1	0	\N	Quin Spa	0	\N	\N	0	0	0	Modi magni facere si	0	\N	0	Gary Schwartz	1	https://www.zujozy.tv	0	\N	\N	\N	999999	1	0	\N	0	\N	\N	\N	0	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	0	\N	\N	0	0	\N	0			\N	0	0	\N	\N	saloon		\N	\N	0	0	\N	\N	https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14449.981861674376!2d55.25688921233106!3d25.1198688709261!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f6976ed4766a3%3A0xb2b2d7132a5134a8!2sDubai%20Hills%20Estate!5e0!3m2!1sen!2sin!4v1715843392141!5m2!1sen!2sin	0	\N	\N	\N	\N	0	\N	\N
3	Alexis Duncan	mulyhiqo@mailinator.com	971	9378912213	1	$2y$10$0beuylnKVtK8rAw9NZ88zODCPld59rc7mwVJbYAqpDAD3ugyG5aR6	\N	4			NNL0gxqGM5FhOW8EnJJ9R2E2kI5wGG3KgoSEegRe.jpg	\N	\N	\N	\N	\N	\N	\N	\N	1	3	2	0	1	0	\N	Hubbard Hair Saloon	0	\N	\N	0	0	0	Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.	0	\N	0	Alexis Duncan	1	https://www.dezijusosalejuk.biz	0	\N	\N	\N	999999	1	0	\N	0	\N	\N	\N	0	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	0	\N	\N	0	0	\N	0			\N	0	0	\N	\N	saloon		\N	\N	0	0	\N	\N	https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14449.981861674376!2d55.25688921233106!3d25.1198688709261!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f6976ed4766a3%3A0xb2b2d7132a5134a8!2sDubai%20Hills%20Estate!5e0!3m2!1sen!2sin!4v1715843392141!5m2!1sen!2sin	0	\N	\N	\N	\N	0	\N	\N
6	Quail Dyer	vumyl@mailinator.com	971	20213123	1	$2y$10$nXjO5fx7hmjGVvrokletpuA/x4WHhLf6zBfMkxTcuX/0feQFpMHeO	\N	4			3ZIt2c2vNdJWYVMcIoSjdOaNSZRlj1TaSx0m7u4g.jpg	\N	\N	\N	\N	\N	\N	\N	\N	1	2	3	0	1	0	\N	Carlos Bates	0	\N	\N	0	0	0	Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.	0	\N	0	Quail Dyer	1	https://www.wypopozariwywy.org.uk	0	\N	\N	\N	999999	1	0	\N	0	\N	\N	\N	0	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	0	\N	\N	0	0	\N	0			\N	0	0	\N	\N	car wash		\N	\N	0	0	\N	\N	https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14449.981861674376!2d55.25688921233106!3d25.1198688709261!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f6976ed4766a3%3A0xb2b2d7132a5134a8!2sDubai%20Hills%20Estate!5e0!3m2!1sen!2sin!4v1715843392141!5m2!1sen!2sin	0	\N	\N	\N	\N	0	\N	\N
5	Rachel Alvarez	hulovofi@mailinator.com	971	24198274	1	$2y$10$qp3C7jkt/qQqD3X/WZoXre8KUcY9oujll8nSN387A5LU/c3OnlFCO	\N	4			R5zg0xj6mzM1pLZFD2SBMVOZUJRvDAHPahuBFyWc.jpg	\N	\N	\N	\N	\N	\N	\N	\N	1	3	1	0	1	0	\N	Dolan Saloon	0	\N	\N	0	0	0	Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.	0	\N	0	Rachel Alvarez	1	https://www.mequkomakogo.com.au	0	\N	\N	\N	999999	1	0	\N	0	\N	\N	\N	0	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	0	\N	\N	0	0	\N	0			\N	0	0	\N	\N	saloon		\N	\N	0	0	\N	\N	https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14449.981861674376!2d55.25688921233106!3d25.1198688709261!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f6976ed4766a3%3A0xb2b2d7132a5134a8!2sDubai%20Hills%20Estate!5e0!3m2!1sen!2sin!4v1715843392141!5m2!1sen!2sin	0	\N	\N	\N	\N	0	\N	\N
7	Smila	sample@gmail.com	\N	+923209823187	0	$2y$10$SBiCrIzu6BEQTMqc7a68BubM8L304jAVKwQyYO476tl5xx8L5esBe	\N	2	\N	\N	1716513896664fec68310b4.jpg	\N	\N	\N	\N	\N	\N	\N	\N	0	0	0	0	0	0	\N	\N	0	\N	\N	0	0	0	\N	0	\N	0	\N	1	\N	0	\N	\N	\N	999999	1	0	\N	0	\N	\N	\N	0	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	0	\N	\N	0	0	\N	0			\N	0	0	\N	\N	\N	\N	\N	\N	0	0	\N	\N	\N	10	543711	25	180	1		20-November-2024	\N
10	Scarlet Newton	bularu@mailinator.com	971	201190238	1	$2y$10$nOqpehhRO7YkYOflIA/fjuHVAEJ8xO9P3C4vhkSVANJcXfzy8Y4VW	\N	4			Yl22eNnPTtHkC6kCslemUmtXaCRpZEUrpJhB7tnc.jpg	\N	\N	\N	\N	\N	\N	\N	\N	1	2	3	0	1	0	\N	Glamour Haven Saloon	0	\N	\N	0	0	0	At Glamour Haven, we believe in the transformative power of beauty. Our team of experienced stylists and beauticians is dedicated to providing personalized services that enhance your natural beauty. From haircuts and coloring to facials and manicures, we offer a comprehensive range of treatments in a relaxing and luxurious environment. Our goal is to make every visit an indulgent escape, leaving you feeling refreshed, confident, and beautiful.	0	\N	0	Scarlet Newton	1	https://www.zelaliwen.us	0	\N	\N	\N	999999	1	0	\N	0	\N	\N	\N	0	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	0	\N	\N	0	0	\N	0			\N	0	0	\N	\N	saloon		\N	\N	0	0	\N	\N	https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14448.757911470857!2d55.20578811722813!3d25.12928417934843!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f6bb3303eb9a5%3A0x785ff078757c69e!2sRRR%20Auto%20Service%20Center!5e0!3m2!1sen!2sin!4v1713530181970!5m2!1sen!2sin	0	\N	\N	\N	\N	0	\N	\N
8	Alizay	alizay@gmail.com	\N	+1241241232	0	$2y$10$WLPtwmb4FsleXKsXs8cABOqWB4vDSSMhB/PW15Xk7UPHLn3CT94ym	\N	2	\N	\N	1716531929665032d9ed643.jpg	\N	\N	\N	\N	\N	\N	\N	\N	0	0	0	0	0	0	\N	\N	0	\N	\N	0	0	0	\N	0	\N	0	\N	1	\N	0	\N	\N	\N	999999	1	0	\N	0	\N	\N	\N	0	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	0	\N	\N	0	0	\N	0			\N	0	0	\N	\N	\N	\N	\N	\N	0	0	\N	\N	\N	0	921919	24	180	1	543711	20-November-2024	\N
1	Admin	admin@admin.com	971	112233445566778899	0	$2y$10$PCzsXHwKvgMmOAzGPK04ie7GK33J7wmabN5rufgVf/5cKyH5QGUmy	\N	1	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	0	0	0	0	0	0	\N	\N	0	\N	\N	0	0	0	\N	0	\N	0	\N	1	\N	0	\N	\N	\N	999999	1	0	\N	0	\N	\N	\N	0	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	0	\N	\N	0	0	\N	0			\N	0	0	\N	\N	\N	\N	\N	\N	0	0	\N	\N	\N	0	\N	\N	\N	\N	0	\N	\N
9	Olga Solomon	citige@mailinator.com	\N	+1 (142) 309-5019	0	$2y$10$fxEcHYz4sKNEbrt6Fa5j4OJuGumg4WsTVGn7oxk2298fwn.BGXJga	\N	2	\N	\N	1716544723665064d396c77.jpg	\N	\N	\N	\N	\N	\N	\N	\N	0	0	0	0	0	0	\N	\N	0	\N	\N	0	0	0	\N	0	\N	0	\N	1	\N	0	\N	\N	\N	999999	1	0	\N	0	\N	\N	\N	0	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	0	\N	\N	0	0	\N	0			\N	0	0	\N	\N	\N	\N	\N	\N	0	0	\N	\N	\N	0	450783	10	30	2		23-June-2024	\N
11	Karen Rasmussen	lukuxik@mailinator.com	971	231893792	1	$2y$10$OLTxx9Iv/f1ufw/qtZ5B9eIt5Ir2zeeoBi9W8SL3sdAjD4pqdsn3W	\N	4			4C8mw5FoQ0sQXQkCaZ30cwd48th3DmXXTKIM1EUm.jpg	\N	\N	\N	\N	\N	\N	\N	\N	1	2	3	0	1	0	\N	Chic Retreat Saloon	0	\N	\N	0	0	0	Chic Retreat is your go-to destination for contemporary beauty services. Our salon combines modern techniques with a chic ambiance to deliver top-notch hair and beauty treatments. Whether you're looking for a trendy haircut, vibrant hair color, or a soothing facial, our skilled professionals are here to cater to your every need. We prioritize customer satisfaction and use only high-quality products to ensure you leave our salon looking and feeling your best.	0	\N	0	Karen Rasmussen	1	https://www.zivoj.org.uk	0	\N	\N	\N	999999	1	0	\N	0	\N	\N	\N	0	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	0	\N	\N	0	0	\N	0			\N	0	0	\N	\N	saloon		\N	\N	0	0	\N	\N	https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14448.757911470857!2d55.20578811722813!3d25.12928417934843!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f6bb3303eb9a5%3A0x785ff078757c69e!2sRRR%20Auto%20Service%20Center!5e0!3m2!1sen!2sin!4v1713530181970!5m2!1sen!2sin	0	\N	\N	\N	\N	0	\N	\N
12	Michael Haley	xito@mailinator.com		548971312729	1	$2y$10$hbGHTV5rQjHf2j0YV7jKyeDsFj8ywnm0DCKTeHNhd4cwpCmuagxQe	\N	4			MbagI8XcGWoJfsi0U4d4UWaMtQn8hDanqHeolH1e.jpg	\N	\N	\N	\N	\N	\N	\N	\N	1	3	2	0	1	0	\N	Urban Oasis	0	\N	\N	0	0	0	Urban Oasis is a sanctuary in the heart of the city, offering a wide array of beauty and wellness services. Our skilled team of stylists and therapists is committed to providing personalized care tailored to your individual needs. We offer everything from cutting-edge haircuts and styling to relaxing massages and spa treatments. Our mission is to provide a holistic approach to beauty and well-being, ensuring you leave our salon feeling revitalized and pampered.	0	\N	0	Michael Haley	1	https://www.nagig.org	0	\N	\N	\N	999999	1	0	\N	0	\N	\N	\N	0	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	0	\N	\N	0	0	\N	0			\N	0	0	\N	\N	saloon		\N	\N	0	0	\N	\N	https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14448.757911470857!2d55.20578811722813!3d25.12928417934843!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f6bb3303eb9a5%3A0x785ff078757c69e!2sRRR%20Auto%20Service%20Center!5e0!3m2!1sen!2sin!4v1713530181970!5m2!1sen!2sin	0	\N	\N	\N	\N	0	\N	\N
13	Otto Ortiz	wefyjezymu@mailinator.com		971912038321	1	$2y$10$ZDNjckB921abhW7FdWkdl.NtxdVwF1Z1J/LtEVtY.Fwua31lE.uPO	\N	4			ix5URlsB8d2qbEiUjHHWaChWO4qAvCArFWlbzvAR.jpg	\N	\N	\N	\N	\N	\N	\N	\N	1	2	3	0	1	0	\N	Serenity Spa & Salon	0	\N	\N	0	0	0	At Serenity Spa & Salon, we focus on creating a tranquil environment where you can escape the stresses of everyday life. Our comprehensive range of services includes therapeutic massages, advanced skincare, and expert hair styling. Our experienced professionals use the latest techniques and high-quality products to deliver outstanding results. Visit Serenity Spa & Salon for a rejuvenating experience that leaves you feeling relaxed and beautiful.	0	\N	0	Otto Ortiz	1	https://www.kobu.me.uk	0	\N	\N	\N	999999	1	0	\N	0	\N	\N	\N	0	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	0	\N	\N	0	0	\N	0			\N	0	0	\N	\N	saloon		\N	\N	0	0	\N	\N	https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14448.757911470857!2d55.20578811722813!3d25.12928417934843!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f6bb3303eb9a5%3A0x785ff078757c69e!2sRRR%20Auto%20Service%20Center!5e0!3m2!1sen!2sin!4v1713530181970!5m2!1sen!2sin	0	\N	\N	\N	\N	0	\N	\N
15	Marshall Short	qidetuqa@mailinator.com		971812738912	1	$2y$10$EIKP7dryRzuKqo/ihrBKteG6eIbMbJwUCGOg5968F6YOwehsHL85a	\N	4			x35FTGkfTMhXJnAbt7ms1tceiX65PiS8wOONR4ES.jpg	\N	\N	\N	\N	\N	\N	\N	\N	1	3	2	0	1	0	\N	Bella Beauty Bar	0	\N	\N	0	0	0	Bella Beauty Bar is your neighborhood salon, committed to enhancing your natural beauty with personalized care. Our friendly and skilled team offers a variety of services, including trendy haircuts, vibrant color treatments, and soothing facials. We take pride in creating a welcoming atmosphere where you can relax and enjoy high-quality beauty services. At Bella Beauty Bar, our goal is to make you look and feel fabulous every time you visit.	0	\N	0	Marshall Short	1	https://www.lubiges.in	0	\N	\N	\N	999999	1	0	\N	0	\N	\N	\N	0	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	0	\N	\N	0	0	\N	0			\N	0	0	\N	\N	saloon		\N	\N	0	0	\N	\N	https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14448.757911470857!2d55.20578811722813!3d25.12928417934843!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f6bb3303eb9a5%3A0x785ff078757c69e!2sRRR%20Auto%20Service%20Center!5e0!3m2!1sen!2sin!4v1713530181970!5m2!1sen!2sin	0	\N	\N	\N	\N	0	\N	\N
16	Kuame Duncan	cabigojit@mailinator.com		97171286312	1	$2y$10$RO9tefdVS4jXzFQ0JnmUuOXCtkfBjYbJpjlzJbkQeWRV8vzDySQHu	\N	4			6hRgMjniT6VVGY4Uh1RPLSJ59Dz3vYRiE6JzZsbw.jpg	\N	\N	\N	\N	\N	\N	\N	\N	1	2	3	0	1	0	\N	Sparkle Shine Car Wash	0	\N	\N	0	0	0	Perferendis eum libe	0	\N	0	Kuame Duncan	1	https://www.qabiramenoqaso.com.au	0	\N	\N	\N	999999	1	0	\N	0	\N	\N	\N	0	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	0	\N	\N	0	0	\N	0			\N	0	0	\N	\N	car wash		\N	\N	0	0	\N	\N	https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14448.757911470857!2d55.20578811722813!3d25.12928417934843!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f6bb3303eb9a5%3A0x785ff078757c69e!2sRRR%20Auto%20Service%20Center!5e0!3m2!1sen!2sin!4v1713530181970!5m2!1sen!2sin	0	\N	\N	\N	\N	0	\N	\N
17	Paki Collier	vihix@mailinator.com		9712813711	1	$2y$10$Q9HzQIuoNjUZBI.y9zjUyugzjGYPxXzc0bAxH7JI/ihL7SZwc8zja	\N	4			8YqO51hw1H6UvWrilD2EbvJsXKvEUJQLmsEEm2D8.jpg	\N	\N	\N	\N	\N	\N	\N	\N	1	2	3	0	1	0	\N	Crystal Clean Car Wash	0	\N	\N	0	0	0	Crystal Clean Car Wash is your one-stop destination for comprehensive car cleaning services. Our experienced professionals use advanced techniques and premium products to deliver exceptional results every time. Whether you need a quick wash or a full-service detail, we have a range of packages to suit your needs. Our mission is to provide a convenient and reliable car wash experience, leaving your vehicle spotless and refreshed. Visit Crystal Clean Car Wash and enjoy the difference of a truly pristine car.	0	\N	0	Paki Collier	1	https://www.waxahat.tv	0	\N	\N	\N	999999	1	0	\N	0	\N	\N	\N	0	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	0	\N	\N	0	0	\N	0			\N	0	0	\N	\N	car wash		\N	\N	0	0	\N	\N	https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14448.757911470857!2d55.20578811722813!3d25.12928417934843!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f6bb3303eb9a5%3A0x785ff078757c69e!2sRRR%20Auto%20Service%20Center!5e0!3m2!1sen!2sin!4v1713530181970!5m2!1sen!2sin	0	\N	\N	\N	\N	0	\N	\N
14	Ebony Giles	badeqy@mailinator.com		972189273121	1	$2y$10$7roHTxf5HxoJsy6VXtptWOLtBzaItclu/FF0XY00UxQy20omZXMh2	\N	4			A46kWuYaWeYyHpRhW1M5tLdZeR69vWIXtsuQ8lUx.jpg	\N	\N	\N	\N	\N	\N	\N	\N	1	3	2	0	1	0	\N	Luxe Lounge	0	\N	\N	0	0	0	Luxe Lounge is synonymous with luxury and excellence in beauty services. Our salon offers a sophisticated and comfortable setting where you can enjoy a range of treatments, from innovative haircuts and color to indulgent facials and manicures. Our talented team is dedicated to staying at the forefront of beauty trends, ensuring you receive the latest and most effective treatments. Discover the epitome of elegance and style at Luxe Lounge.	0	\N	0	Ebony Giles	1	https://www.mawutodojex.co.uk	0	\N	\N	\N	999999	1	0	\N	0	\N	\N	\N	0	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	0	\N	\N	0	0	\N	0			\N	0	0	\N	\N	saloon		\N	\N	0	0	\N	\N	https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14448.757911470857!2d55.20578811722813!3d25.12928417934843!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f6bb3303eb9a5%3A0x785ff078757c69e!2sRRR%20Auto%20Service%20Center!5e0!3m2!1sen!2sin!4v1713530181970!5m2!1sen!2sin	0	\N	\N	\N	\N	0	\N	\N
\.
...
1	admin	2024-05-24 00:18:07	2024-05-24 00:18:07
2	users	2024-05-24 00:18:07	2024-05-24 00:18:07
3	vendors	2024-05-24 00:18:07	2024-05-24 00:18:07
\.
...
--
-- Data for Name: video_downloads; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.video_downloads (id, user_id, video_id, coupon_id, created_at, updated_at) FROM stdin;
\.
...
COPY public.video_views (id, user_id, video_id, created_at, updated_at, coupon_id) FROM stdin;
\.
...
COPY public.wishlists (id, status, user_id, vendor_id, created_at, updated_at) FROM stdin;
1	1	8	4	2024-05-24 07:05:16	2024-05-24 07:05:16
2	1	8	5	2024-05-24 07:08:38	2024-05-24 07:08:38
\.
...
--
-- Name: contact_us_data_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.contact_us_data_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.contact_us_id_seq', 3, true);
...
--
-- Name: coupon_image_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.coupon_image_id_seq', 1, false);


--
-- Name: coupon_order_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.coupon_order_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.coupon_unlock_videos_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.home_banners_id_seq', 2, true);


--
-- Name: home_page_about_data_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.home_page_about_data_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.migrations_id_seq', 416, true);
...
--
-- Name: operating_hours_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.operating_hours_id_seq', 91, true);
...
--
-- Name: our_customers_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.our_customers_id_seq', 5, true);
...
SELECT pg_catalog.setval('public.photos_id_seq', 54, true);
...
SELECT pg_catalog.setval('public.provider_registration_id_seq', 1, false);
...
--
-- Name: service_obtains_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.service_obtains_id_seq', 1, true);
...
--
-- Name: term_conditions_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.term_conditions_id_seq', 1, true);
...
--
-- Name: video_downloads_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.video_downloads_id_seq', 1, false);


--
-- Name: video_views_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
--
-- Name: contact_us_data contact_us_data_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.contact_us_data
    ADD CONSTRAINT contact_us_data_pkey PRIMARY KEY (id);
...
--
-- Name: coupon_image coupon_image_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.coupon_image
    ADD CONSTRAINT coupon_image_pkey PRIMARY KEY (id);


--
-- Name: coupon_order coupon_order_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.coupon_order
    ADD CONSTRAINT coupon_order_pkey PRIMARY KEY (id);
...
--
-- Name: home_page_about_data home_page_about_data_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.home_page_about_data
    ADD CONSTRAINT home_page_about_data_pkey PRIMARY KEY (id);
...
--
-- Name: our_customers our_customers_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.our_customers
    ADD CONSTRAINT our_customers_pkey PRIMARY KEY (id);
...
--
-- Name: service_obtains service_obtains_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.service_obtains
    ADD CONSTRAINT service_obtains_pkey PRIMARY KEY (id);
...
--
-- Name: term_conditions term_conditions_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.term_conditions
    ADD CONSTRAINT term_conditions_pkey PRIMARY KEY (id);
...
--
-- Name: video_downloads video_downloads_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: operating_hours operating_hours_vendor_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.operating_hours
    ADD CONSTRAINT operating_hours_vendor_id_foreign FOREIGN KEY (vendor_id) REFERENCES public.users(id) ON DELETE CASCADE;
...
--
-- Name: service_obtains service_obtains_service_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.service_obtains
    ADD CONSTRAINT service_obtains_service_id_foreign FOREIGN KEY (service_id) REFERENCES public.services(id) ON DELETE CASCADE;


--
-- Name: service_obtains service_obtains_user_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.service_obtains
    ADD CONSTRAINT service_obtains_user_id_foreign FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;


--
-- Name: service_obtains service_obtains_vendor_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.service_obtains
    ADD CONSTRAINT service_obtains_vendor_id_foreign FOREIGN KEY (vendor_id) REFERENCES public.users(id) ON DELETE CASCADE;


--
-- Name: services services_vendor_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.services
    ADD CONSTRAINT services_vendor_id_foreign FOREIGN KEY (vendor_id) REFERENCES public.users(id) ON DELETE CASCADE;
...
--
-- Name: users users_subscription_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.users
    ADD CONSTRAINT users_subscription_id_foreign FOREIGN KEY (subscription_id) REFERENCES public.subscriptions(id) ON DELETE SET NULL;
...
--
-- Name: wishlists wishlists_vendor_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.wishlists
    ADD CONSTRAINT wishlists_vendor_id_foreign FOREIGN KEY (vendor_id) REFERENCES public.users(id) ON DELETE CASCADE;
